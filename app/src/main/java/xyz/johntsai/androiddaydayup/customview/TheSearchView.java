 ...
 * Copied from https://github.com/GcsSloop/AndroidNote/blob/master/CustomView/Advance/Code/SearchView.md
 */

public class TheSearchView extends View {

    private static final String TAG = TheSearchView.class.getSimpleName();
    ...
    public TheSearchView(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public TheSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                        mStartingAnimator.removeAllListeners();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(-mViewWidth/2,0,mViewWidth/2,0,linePaint);
        canvas.drawLine(0,mViewHeight/2,0,-mViewHeight/2,linePaint);

        canvas.drawColor(Color.parseColor("#800082D7"));
        drawSearch(canvas);
    }
    ...
    private void drawSearch(Canvas canvas) {
        ...
        switch (mCurrentState) {
            ...
            case SEARCHING:
                ...
                Log.d(TAG,"value="+mAnimatorValue+"start = "+start+"  end="+stop);
    ...
    public boolean isAnimating(){
        return mCurrentState!=State.NONE;
    }
}